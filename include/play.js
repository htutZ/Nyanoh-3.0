  ...
  async play(song, message) {
    ...
    if (!song) {
      setTimeout(function () {
        ...
        queue.channel.leave();
        queue.textChannel.send("Goodbyeee Nyamrades...");
      }, STAY_TIME * 10000);
    ...
    collector.on("collect", (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        case "⏭":
          ...
          queue.textChannel.send(`${user} ⏩ Nyajesty doesn't like this.`).catch(console.error);
          collector.stop();
          break;
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            queue.textChannel.send(`${user} ⏸ Nyajesty's gonna take a rest.`).catch(console.error);
          } else {
            queue.playing = !queue.playing;
