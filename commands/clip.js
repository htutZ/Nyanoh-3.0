...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (queue) return message.reply("Can't play clip because there is an active queue nyaa!.");
    if (!channel) return message.reply("Join a voice channel first nyaaa!").catch(console.error);
